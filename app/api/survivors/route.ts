...
// Values are approximate — will be replaced with real data from WorkerPost if available
// UR = best, N = weakest
const ROLE_DATA: Record<string, {
  ...
  'Farmer': { building: 'Farm', effectsByRarity: {
    UR: [{label:'Food Output', value:'+10%'}, {label:'Production Time', value:'+4h'}],
    SSR: [{label:'Food Output', value:'+8%'}, {label:'Production Time', value:'+3h'}],
    SR: [{label:'Food Output', value:'+5%'}, {label:'Production Time', value:'+2h'}],
    R: [{label:'Food Output', value:'+3%'}, {label:'Production Time', value:'+1h'}],
    N: [{label:'Food Output', value:'+1%'}],
  }},
  'Lumberjack': { building: 'Lumberyard', effectsByRarity: {
    UR: [{label:'Timber Output', value:'+10%'}, {label:'Production Time', value:'+4h'}],
    SSR: [{label:'Timber Output', value:'+8%'}, {label:'Production Time', value:'+3h'}],
    SR: [{label:'Timber Output', value:'+5%'}, {label:'Production Time', value:'+2h'}],
    R: [{label:'Timber Output', value:'+3%'}, {label:'Production Time', value:'+1h'}],
    N: [{label:'Timber Output', value:'+1%'}],
  }},
  'Herbalist': { building: 'Herb Garden', effectsByRarity: {
    UR: [{label:'Herb Output', value:'+10%'}, {label:'Production Time', value:'+4h'}],
    SSR: [{label:'Herb Output', value:'+8%'}, {label:'Production Time', value:'+3h'}],
    SR: [{label:'Herb Output', value:'+5%'}, {label:'Production Time', value:'+2h'}],
    R: [{label:'Herb Output', value:'+3%'}, {label:'Production Time', value:'+1h'}],
    N: [{label:'Herb Output', value:'+1%'}],
  }},
  'Nurse': { building: 'Infirmary', effectsByRarity: {
    UR: [{label:'Healing Speed', value:'+10%'}, {label:'Capacity', value:'+500'}],
    SSR: [{label:'Healing Speed', value:'+8%'}, {label:'Capacity', value:'+350'}],
    SR: [{label:'Healing Speed', value:'+5%'}, {label:'Capacity', value:'+200'}],
    R: [{label:'Healing Speed', value:'+3%'}, {label:'Capacity', value:'+100'}],
    N: [{label:'Healing Speed', value:'+1%'}],
  }},
  'Officer': { building: 'Barracks', effectsByRarity: {
    UR: [{label:'Troop Capacity', value:'+2,400'}],
    SSR: [{label:'Troop Capacity', value:'+1,600'}],
    SR: [{label:'Troop Capacity', value:'+1,000'}],
    R: [{label:'Troop Capacity', value:'+500'}],
    N: [{label:'Troop Capacity', value:'+200'}],
  }},
  'Instructor': { building: 'Training Grounds', effectsByRarity: {
    UR: [{label:'Training Cap', value:'+500'}, {label:'Soldier Lv', value:'+2'}],
    SSR: [{label:'Training Cap', value:'+350'}],
    SR: [{label:'Training Cap', value:'+200'}],
    R: [{label:'Training Cap', value:'+100'}],
    N: [{label:'Training Cap', value:'+50'}],
  }},
  'Researcher': { building: 'Research Lab', effectsByRarity: {
    UR: [{label:'Research Speed', value:'+10%'}, {label:'Free Speedup', value:'+30min'}],
    SSR: [{label:'Research Speed', value:'+8%'}, {label:'Free Speedup', value:'+15min'}],
    SR: [{label:'Research Speed', value:'+5%'}],
    R: [{label:'Research Speed', value:'+3%'}],
    N: [{label:'Research Speed', value:'+1%'}],
  }},
  'Builder': { building: "Builder's Hut", effectsByRarity: {
    UR: [{label:'Free Speedup', value:'+30min'}],
    SSR: [{label:'Free Speedup', value:'+15min'}],
    SR: [{label:'Free Speedup', value:'+10min'}],
    R: [{label:'Free Speedup', value:'+5min'}],
    N: [{label:'Free Speedup', value:'+2min'}],
  }},
  'Blacksmith': { building: 'Gear Workshop', effectsByRarity: {
    UR: [{label:'Crafting Speed', value:'+10%'}],
    SSR: [{label:'Crafting Speed', value:'+8%'}],
    SR: [{label:'Crafting Speed', value:'+5%'}],
    R: [{label:'Crafting Speed', value:'+3%'}],
    N: [{label:'Crafting Speed', value:'+1%'}],
  }},
  'Explorer': { building: "Explorer's Camp", effectsByRarity: {
    UR: [{label:'Loot Output', value:'+10%'}, {label:'Idle Time', value:'+4h'}],
    SSR: [{label:'Loot Output', value:'+8%'}, {label:'Idle Time', value:'+3h'}],
    SR: [{label:'Loot Output', value:'+5%'}],
    R: [{label:'Loot Output', value:'+3%'}],
    N: [{label:'Loot Output', value:'+1%'}],
  }},
  'Attendant': { building: 'Tavern', effectsByRarity: {
    UR: [{label:'Hero Recruit CD', value:'-10%'}, {label:'Survivor CD', value:'-10%'}],
    SSR: [{label:'Hero Recruit CD', value:'-8%'}],
    SR: [{label:'Hero Recruit CD', value:'-5%'}],
    R: [{label:'Hero Recruit CD', value:'-3%'}],
    N: [{label:'Hero Recruit CD', value:'-1%'}],
  }},
  'Liaison': { building: 'Alliance Hall', effectsByRarity: {
    UR: [{label:'Help Count', value:'+5'}, {label:'Help Duration', value:'+30min'}],
    SSR: [{label:'Help Count', value:'+3'}],
    SR: [{label:'Help Count', value:'+2'}],
  }},
  'Grain Keeper': { building: 'Granary', effectsByRarity: {
    UR: [{label:'Protected Grain', value:'+10%'}],
    SSR: [{label:'Protected Grain', value:'+8%'}],
    SR: [{label:'Protected Grain', value:'+5%'}],
    R: [{label:'Protected Grain', value:'+3%'}],
    N: [{label:'Protected Grain', value:'+1%'}],
  }},
  'Timber Keeper': { building: 'Lumber Depot', effectsByRarity: {
    UR: [{label:'Protected Timber', value:'+10%'}],
    SSR: [{label:'Protected Timber', value:'+8%'}],
    SR: [{label:'Protected Timber', value:'+5%'}],
    R: [{label:'Protected Timber', value:'+3%'}],
    N: [{label:'Protected Timber', value:'+1%'}],
  }},
  'Herb Keeper': { building: 'Herb Storage', effectsByRarity: {
    UR: [{label:'Protected Herb', value:'+10%'}],
    SSR: [{label:'Protected Herb', value:'+8%'}],
    SR: [{label:'Protected Herb', value:'+5%'}],
    R: [{label:'Protected Herb', value:'+3%'}],
    N: [{label:'Protected Herb', value:'+1%'}],
  }},
}
